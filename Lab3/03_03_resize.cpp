...
void CreateVBO(void)
{
	...
	GLfloat Vertices[] = {
		...
		330.0f, 250.0f, 0.0f, 1.0f,
		315.0f, 275.0f, 0.0f, 1.0f,
		330.0f, 300.0f, 0.0f, 1.0f,
		...
		////fasia de prima nuanta de albastru de sub poligonul convex
		//100.0f, 0.0f, 0.0f, 1.0f,
		//200.0f, 0.0f, 0.0f, 1.0f,
		//200.0f, 100.0f, 0.0f, 1.0f,
		//100.0f, 100.0f, 0.0f, 1.0f,

		////fasia de prima nuanta de albastru de deasupra poligonul convex
		//100.0f, 200.0f, 0.0f, 1.0f,
		//200.0f, 200.0f, 0.0f, 1.0f,
		//200.0f, 400.0f, 0.0f, 1.0f,
		//100.0f, 400.0f, 0.0f, 1.0f,

		////fasia cu a 2a nuanta de albastru
		//200.0f, 0.0f, 0.0f, 1.0f,
		//300.0f, 0.0f, 0.0f, 1.0f,
		//300.0f, 400.0f, 0.0f, 1.0f,
		//200.0f, 400.0f, 0.0f, 1.0f,

		////fasia cu a 3a nuanta de albastru de dupa poligonul concav
		//330.0f, 0.0f, 0.0f, 1.0f,
		//400.0f, 0.0f, 0.0f, 1.0f,
		//400.0f, 400.0f, 0.0f, 1.0f,
		//330.0f, 400.0f, 0.0f, 1.0f,

		////fasia cu a 3a nuanta de albastru de deasupra poligonul concav
		//300.0f, 300.0f, 0.0f, 1.0f,
		//330.0f, 300.0f, 0.0f, 1.0f,
		//330.0f, 400.0f, 0.0f, 1.0f,
		//300.0f, 400.0f, 0.0f, 1.0f,

		////fasia cu a 3a nuanta de albastru de sub poligonul concav
		//300.0f, 0.0f, 0.0f, 1.0f,
		//330.0f, 0.0f, 0.0f, 1.0f,
		//330.0f, 250.0f, 0.0f, 1.0f,
		//300.0f, 250.0f, 0.0f, 1.0f,

		////fasia cu a 3a nuanta de albastru din interiorul poligonului concav
		//330.0f, 250.0f, 0.0f, 1.0f,
		//330.0f, 300.0f, 0.0f, 1.0f,
		//315.0f, 275.0f, 0.0f, 1.0f,

		// puncte entru gradient
		10.0f, 10.0f, 0.0f, 1.0f,
		390.0f, 10.0f, 0.0f, 1.0f,
		390.0f, 390.0f, 0.0f, 1.0f,
		10.0f, 390.0f, 0.0f, 1.0f,
...
{
	//glClearColor(0.0f, 0.0f, 1.0f, 1.0f); // culoarea de fond a ecranului
