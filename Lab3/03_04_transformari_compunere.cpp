...
glm::mat4 
	...
	matrRotPolConvex, matrTransl1PolConvex, matrTransl2PolConvex,
	matrRotPolConcav, matrTransl1PolConcav, matrTransl2PolConcav;
...
void Initialize(void)
{
	...
	GLfloat angle = PI / 8; 
	GLfloat anglePolConvex = PI / 12;
	GLfloat anglePolConcav = PI / 4;
	...
	//Poligonul convex
	matrRotPolConvex = glm::rotate(glm::mat4(1.0f), anglePolConvex, glm::vec3(0.0, 0.0, 1.0));
	matrTransl1PolConvex = glm::translate(glm::mat4(1.0f), glm::vec3(150.f, -150.f, 0.0));
	matrTransl2PolConvex = glm::translate(glm::mat4(1.0f), glm::vec3(-150.f, 150.f, 0.0));

	// poligonul concav
	matrRotPolConcav = glm::rotate(glm::mat4(1.0f), anglePolConcav, glm::vec3(0.0, 0.0, 1.0));
	matrTransl1PolConcav = glm::translate(glm::mat4(1.0f), glm::vec3(-325.f, -200.f, 0.0));
	matrTransl2PolConcav = glm::translate(glm::mat4(1.0f), glm::vec3(325.f, 200.f, 0.0));
}
void RenderFunction(void)
{
	...
	myMatrix = resizeMatrix * matrTransl2PolConvex * matrRotPolConvex * matrTransl1PolConvex;
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
	codCol = 2;
	glUniform1i(codColLocation, codCol);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	...
	myMatrix = resizeMatrix * matrTransl2PolConcav * matrRotPolConcav * matrTransl1PolConcav;
	glUniformMatrix4fv(myMatrixLocation, 1, GL_FALSE, &myMatrix[0][0]);
	codCol = 2;
	glUniform1i(codColLocation, codCol);
	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
